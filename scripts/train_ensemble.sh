...
# PARALLEL_JOBS=5 GPU_IDS=0,1,2,3,4 ./scripts/train_ensemble.sh --data_path ../dataset/ready_v6_t1xTruexTB_FalsexTB_stereo_cycle0/ --dim 192 --n_layer 5 --lr 2e-4 --num_worker 32 --epoch 200 --fusion_mode film
